                            ...
                            if(result != ""){
                                ...
                                connection.query(
                                    ...
                                    (error, result, field) => {
                                        ...
                                        if(result != ""){
                                            let idProfessor = result[Object.keys(result)[0]]["idProfessor"]
                                            ...
                                            connection.query(
                                                ...
                                                (error, result, field) => {
                                                    ...
                                                    if(result != ""){
                                                        ...
                                                        const sqlAvaliador = 'SELECT idAvaliador FROM tblAluno WHERE idUsuario = ?'
                                                        connection.query(
                                                            sqlAvaliador,
                                                            idUsuario,
                                                            (error, result, field) => {
                                                                ...
                                                                let idAvaliador = result[Object.keys(result)[0]]["idAvaliador"]
