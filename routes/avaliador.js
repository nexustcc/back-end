...
router.post("/cadastrarAvaliador/:idInstituicao", (req, res) => {
    mysql.connect((error, connection) => {
        ...
        const sqlUsuario = "INSERT INTO tblusuario (nome, email, senha) VALUES (?, ?, ?)";
        ...
        connection.query(
            ...
            (error, result, field) => {
                ...
                const sqlAvaliador = "INSERT INTO tblAvaliador (idInstituicao, idUsuario) VALUES (?, ?)"
                ...
                connection.query(
                    ...
                    (error, result, field) => {
                        ...
                        let sqlGrupos = 'INSERT INTO tblAvaliadorGrupo (idAvaliador, idGrupo) VALUES (?, ?)'
...
router.get("/listarAvaliador/:idAvaliador", (req, res) => {
    mysql.connect((error, connection) => {
        ...
        const sqlGrupos = 'SELECT nomeGrupo FROM tblGrupo INNER JOIN tblAvaliadorGrupo ON tblGrupo.idGrupo = tblAvaliadorGrupo.idGrupo WHERE idAvaliador = ?'
        connection.query(
            sqlGrupos,
            ...
            (error, result, field) => {
                ...
                const sql = "SELECT nome, email, senha FROM tblAvaliador INNER JOIN tblUsuario ON tblAvaliador.idUsuario = tblUsuario.idUsuario WHERE idAvaliador = ?";
...
router.put('/editarAvaliador/:idAvaliador', (req, res) => {
    mysql.connect((error, connection) => {
        ...
        const sqlIdAvaliador = 'SELECT idGrupo FROM tblAvaliadorGrupo WHERE idAvaliador = ?'
        connection.query(
            sqlIdAvaliador,
            req.params.idAvaliador,
            (error, result, field) => {
                ...
                if (idGruposDeletar.length != 0) {
                    ...
                    const sqlDeletarGrupos = 'DELETE FROM tblAvaliadorGrupo WHERE idAvaliador = ? AND idGrupo = ?'
                ...
                if (idGruposAvaliador.length != 0) {
                    ...
                    const sqlAdicionarGrupos = 'INSERT INTO tblAvaliadorGrupo (idAvaliador, idGrupo) VALUES (?, ?)'
                ...
                connection.query(
                    ...
                    (error, result, field) => {
                        ...
                        const sqlEditUsuario = "UPDATE tblUsuario SET nome = ?, email = ?, senha = ? WHERE idUsuario = ?";
                        const valuesUsuario = [
                                req.body.nome,
                                req.body.email,
                                req.body.senha,
...
router.delete('/deletarAvaliador/:idAvaliador', (req, res) => {
    mysql.connect((error, connection) => {
        ...
        const sqlAvalidorGrupos = "DELETE FROM tblAvaliadorGrupo WHERE idAvaliador = ?";
        connection.query(
            sqlAvalidorGrupos, 
            req.params.idAvaliador, 
            (error, result, field) => {
                            ...
                            (error, result, field) => {
                                ...
                                connection.query(
                                    ...
                                    (error, result, field) => {
                                        ...
                                        const sqlExcluirUsuario = "DELETE FROM tblUsuario WHERE idUsuario = ?";
                                        connection.query(
                                            sqlExcluirUsuario, 
                                            idUsuario, 
                                            (error, result, field) => {
